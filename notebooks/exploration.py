...
# ===== NOUVELLE ANALYSE : PATIENTS PAR SEXE ET DIAGNOSTIC =====
...
# Optionnel : Affichage en tableau croisé plus lisible
print(f"\n--- Tableau croise : sexe vs diagnostic ---")
pivot_table = df.groupby(["sexe", "diagnostic"]).size().unstack(fill_value=0)
print(pivot_table)
